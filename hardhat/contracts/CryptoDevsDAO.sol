...
contract CryptoDevsDAO is Ownable {
    ...
    */
    ...
    /**
        ...
        @param _indexProposal the index of the proposal to vote
    */
    ...
    /**
        @dev allows a CryptoDevs holder to execute the proposal when it is inactive. If the proposal is accepted the DAO contract will purchase an NFT
        @param _indexProposal index of the proposal to execute 
     */
        ...
        inactiveProposalOnly(_indexProposal)
    {
        ...
        if(proposal.yayVotes > proposal.nayVotes) {
            ...
            // send to nftMarketplace contract an amount of ETH equal to the price of the NFT
            nftMatketplace.purchase{value: nftPrice}(proposal.nftTokenId);
        } 
        // if the proposal is not approved, nothing happens. In both cases the proposal is marked as executed
        ...
        onlyOwner
    {
        ...
        require(amount > 0, "CryptoDevsDAO: No ETH to withdraw");

        (bool sent, ) = payable(owner()).call{value: amount}("");
        require(sent, "CryptoDevsDAO: Failed to withdraw ETH");
    }
